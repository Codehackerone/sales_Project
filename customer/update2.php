  ...
  include_once('../bootstrap.php');
   ...
   else
    {
      $custid = $_POST['custname'];
		    ...
		    $sql = "SELECT cust_id,cust_name,cust_add,cust_phno,gstin,state,stateid FROM customer1 WHERE cust_name LIKE '%$custid%'";
  ...
  <datalist id="stateer">
    ...
    <form action="update3.php" method="post" >
      <div class="form-group">
            <input type="text" id="custid" required placeholder="NEW CUSTOMER ID" class="form-control"name="custid" readonly>
          </div><div class="form-group">
            <input type="text" id="custname" required placeholder="NEW CUSTOMER NAME" class="form-control"name="custname">
            </div><div class="form-group">
            <input type="text" id="custadd" required placeholder="NEW CUSTOMER ADDRESS"class="form-control" name="custadd">
            </div><div class="form-group">
            <input type="text" id="custph" required placeholder="NEW CUSTOMER PHONE" class="form-control"name="custph">
            </div><div class="form-group">
            <input type="text"  placeholder="GSTIN NUMBER"  id="gstin" name="gstin" class="form-control">
            </div><div class="form-group">
            <input list="stateer" name="statename" id="state" placeholder="STATE NAME" onchange="showCustomer(this.value)"class="form-control"></input>
            </div><div class="form-group">
            <input type="text" readonly id="statec" name="statecode" placeholder="STATE ID"class="form-control">
</div><div class="form-group">
